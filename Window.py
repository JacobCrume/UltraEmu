...
if theme == 'azure' or theme == 'forest':
    PS1_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=0)
    PS1_Button.configure(style='ToggleButton')
    PS1_Button.pack(padx='5', pady='5', side='top')
    PS2_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=1)
    PS2_Button.configure(style='ToggleButton')
    PS2_Button.pack(side='top')
    PS3_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=2)
    PS3_Button.configure(style='ToggleButton')
    PS3_Button.pack(pady='5', side='top')
    PSP_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=3)
    PSP_Button.configure(style='ToggleButton')
    PSP_Button.pack(side='top')
    Xbox_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=4)
    Xbox_Button.configure(style='ToggleButton')
    Xbox_Button.pack(pady='5', side='top')
    Xbox_360_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=5)
    Xbox_360_Button.configure(style='ToggleButton')
    Xbox_360_Button.pack(side='top')
    Wii_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=6)
    Wii_Button.configure(style='ToggleButton')
    Wii_Button.pack(pady='5', side='top')
    Wii_U_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=7)
    Wii_U_Button.configure(style='ToggleButton')
    Wii_U_Button.pack(side='top')
    Settings_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=8)
    Settings_Button.configure(style='ToggleButton')
    Settings_Button.pack(pady='0 5', side='bottom')
    Downloads_Button = ttk.Radiobutton(Left_Navigation, variable=Vertical_Tabs, value=9)
...
Simulator_Games_Button_1 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[0][0], image=Simulator_Games_Button_1_Icon, compound='top')
Simulator_Games_Button_1.pack(side='left', padx=5, pady=10, fill='y')
Simulator_Games_Button_2 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[1][0], image=Simulator_Games_Button_2_Icon, compound='top')
Simulator_Games_Button_2.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_3 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[2][0], image=Simulator_Games_Button_3_Icon, compound='top')
Simulator_Games_Button_3.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_4 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[3][0], image=Simulator_Games_Button_4_Icon, compound='top')
Simulator_Games_Button_4.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_5 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[4][0], image=Simulator_Games_Button_5_Icon, compound='top')
Simulator_Games_Button_5.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_6 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[5][0], image=Simulator_Games_Button_6_Icon, compound='top')
Simulator_Games_Button_6.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_7 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[6][0], image=Simulator_Games_Button_7_Icon, compound='top')
Simulator_Games_Button_7.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_8 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[7][0], image=Simulator_Games_Button_8_Icon, compound='top')
Simulator_Games_Button_8.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_9 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[8][0], image=Simulator_Games_Button_9_Icon, compound='top')
Simulator_Games_Button_9.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_10 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[9][0], image=Simulator_Games_Button_10_Icon, compound='top')
Simulator_Games_Button_10.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_11 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[10][0], image=Simulator_Games_Button_11_Icon, compound='top')
Simulator_Games_Button_11.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_12 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[11][0], image=Simulator_Games_Button_12_Icon, compound='top')
Simulator_Games_Button_12.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_13 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[12][0], image=Simulator_Games_Button_13_Icon, compound='top')
Simulator_Games_Button_13.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_14 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[13][0], image=Simulator_Games_Button_14_Icon, compound='top')
Simulator_Games_Button_14.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_15 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[14][0], image=Simulator_Games_Button_15_Icon, compound='top')
Simulator_Games_Button_15.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_16 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[15][0], image=Simulator_Games_Button_16_Icon, compound='top')
Simulator_Games_Button_16.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_17 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[16][0], image=Simulator_Games_Button_17_Icon, compound='top')
Simulator_Games_Button_17.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_18 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[17][0], image=Simulator_Games_Button_18_Icon, compound='top')
Simulator_Games_Button_18.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_19 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[18][0], image=Simulator_Games_Button_19_Icon, compound='top')
Simulator_Games_Button_19.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_20 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[19][0], image=Simulator_Games_Button_20_Icon, compound='top')
Simulator_Games_Button_20.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_21 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[20][0], image=Simulator_Games_Button_21_Icon, compound='top')
Simulator_Games_Button_21.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_22 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[21][0], image=Simulator_Games_Button_22_Icon, compound='top')
Simulator_Games_Button_22.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_23 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[22][0], image=Simulator_Games_Button_23_Icon, compound='top')
Simulator_Games_Button_23.pack(side='left', padx='0 5', pady=10, fill='y')
Simulator_Games_Button_24 = ttk.Button(Simulator_Games_Content.innerframe, text=recommended_games_PS3_simulation[23][0], image=Simulator_Games_Button_24_Icon, compound='top')
